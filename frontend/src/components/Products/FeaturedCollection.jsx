    ...
    <section className="py-16 px-4 lg:px-0">
        <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center bg-green-50 rounded-3xl">
            ...
            <div className="lg:w-1/2 p-8 text-center lg:text-left">
                <h2 className="text-lg font-semibold text-gray-700mb-2">Comfort and Style</h2>
                <h2 className="text-4xl lg:text-5xl font-bold tmb-6">Apparel made for everyday life</h2>
            ...
            <div className="lg:w-1/2">
                ...
                className="w-full h-full object-cover lg:rounded-tr-3xl lg:rounded-br-3xl" loading="lazy" decoding="async" />
            </div>
        </div>
    </section>
  )
